...
path = os.path.join(mkdir_if_not_exists(f'graph/{"v" if args.vae else ""}ae'), f"{'aug_' if args.aug else ''}{'onlykl' if args.kl else 'nokl' if args.no_kl else ''}_t{args.threshold:.3f}.png")
